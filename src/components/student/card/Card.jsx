...
import { HiBookmark, HiHeart, HiIdentification, HiOutlinePencilAlt, HiOutlineTrash } from "react-icons/hi";
...
const DocumentCard = (props) => {
    ...
    return (
        <>
            <Tooltip content={docName} style="light">
                <div className="rounded-lg h-[21rem] h-full border-gray-200 border shadow-lg bg-white cursor-pointer hover:bg-green-100 focus:bg-green-50 active:bg-green-50 focus:border-green-200 active:border-green-200 focus:border-2 active:border-2" onClick={() => navigate(`/documents/${slug}`)}>
