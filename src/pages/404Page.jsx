    ...
    return (
        <div class="flex flex-col justify-center items-center px-6 mx-auto h-screen xl:px-0 dark:bg-gray-900">
            ...
            <div class="text-center xl:max-w-4xl">
                ...
                <a class="bg-white cursor-pointer transition font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-3 " style={{ color: "var(--main-color)", boxShadow: "var(--box-shadow)", borderRadius: "var(--border-radius)" }} onClick={() => navigate(-1)}>
